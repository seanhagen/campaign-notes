...
****** first version
:PROPERTIES:
:ID:       ef3753e0-26a4-4abc-bb8c-a929b64e1038
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/rpg_1.png]]
****** second version 
:PROPERTIES:
:ID:       08bac3b0-d809-4e6d-ad99-a59bf7911b87
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/rpg_3.png]]
****** third version
:PROPERTIES:
:ID:       6491f9af-60cc-4190-b2ed-7a0ae3cf2a10
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/morrowind.webp]]
***** what FOX sees
metal gear solid (first one) ( top down 2d action game )
****** first version
#+ATTR_ORG: :width 500px

[[file:./assets/metal_gear.gif]]
****** second version
:PROPERTIES:
:ID:       ba1b365d-961f-42e8-8047-c59794f13e6d
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/metal_gear_2.jpg]]
****** third version
:PROPERTIES:
:ID:       c870cb58-6d3b-458b-a48c-90db7e7c2042
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/metal_gear_5.jpg]]
***** what KLEP sees
return to castle wolfenstein
****** first version
#+ATTR_ORG: :width 500px
[[file:./assets/castle_wolfeinstein_1.jpg]]
****** second version
:PROPERTIES:
:ID:       3aeeda3d-c01f-4cdd-a409-017bb5130d16
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/castle_wolfenstein_2.png]]
****** third version
:PROPERTIES:
:ID:       26628d29-4749-4e46-a357-15fb98831256
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/wolfenstein_3.jpg]]
***** what BELEL sees
point and click adventure game
****** first version
:PROPERTIES:
:ID:       2844a0da-8f10-464f-ae63-0e42952affc2
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/maniac_mansion.webp]]
****** second version
:PROPERTIES:
:ID:       4f552248-b705-421f-a7cf-6fcd2657dbb9
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/point_and_click_2.webp]]
****** third version
:PROPERTIES:
:ID:       9c8a873b-5e1f-4320-86fa-a271a04855f0
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/point_and_click_3.jpg]]
...
****** version 1
#+ATTR_ORG: :width 500px
[[file:./assets/submarine_1.png]]
****** version 2 
:PROPERTIES:
:ID:       cc70376c-7d4e-4a0f-8da3-e8df8392636e
:END:
#+ATTR_ORG: :width 500px
[[file:./assets/sub_1.png]]
****** version 3
#+ATTR_ORG: :width 500px
[[file:./assets/sub_3.webp]]
...
#+BEGIN_QUOTE
you find yourself standing inside a small cube, about the size of the room you're in right now. the cube appears to be made of steel-glass; you can't seem to break it, or even scratch it. on the other side of the glass all you can see is a hash of black and white static. in the center of the cube is a chair.

you recognize this as some descriptions you've heard of the neutral space some folks said is the place you go before entering the datasphere.

in this place, your "body" is an avatar, highly influenced by your subconscious and state of mind. your avatar is something first-time visitors to the datasphere often find surprising.

describe your avatar.
#+END_QUOTE

let them describe their character's datasphere avatar

#+BEGIN_QUOTE
what do you do (describe in one sentence)?
#+END_QUOTE
...
#+BEGIN_QUOTE
suddenly, a loud "bong" sounds from all around you, and the static is replaced
by darkness. then, you see some glowing white text in the top-left of the face
of the cube directly in front of the chair. it seems to be writing itself. it's
in a language you don't understand, but it seems to be very succinct language,
the sentences are very short. when the text eventually reaches the bottom, it
begins to scroll up. What do you do?
#+END_QUOTE

whatever they do, eventually this happens:

#+BEGIN_QUOTE
after a few more moments, the face of the cube in front of you turns a bright
blue, before dimming enough that you can make out some kind of display. there
appears to be some kind of input required. what do you do?
#+END_QUOTE
...
spiral moves, and a low droning voice speaks in a language you don't understand.
...
******* if they haven't
#+BEGIN_QUOTE
The creature speaks, responding in Truth ( although from the accent you suspect
they learned Truth from someone from the Steadfast ).

"Oh, i know this one! I'm sure glad we got that sorted out! I can't help you get
this problem sorted out if we can't understand each other, now, can we?"

"My name is Clippy, and it seems like you're having problems logging in. Is
...
[[file:./assets/klep-ship-maze-rotated.png]]

 - green W ( north of start ) -> "weapon" ( klep already has this )
 - k1 -> key for doors marked with 1 ( and so on for k2, k3 )
 - purple 'b' -- bad guy, can sneak past or killed, will drop 'loot'
 - purple 'eye' -- bad guy, can't be killed, need shield to get past these
 - boss -- have to have sword & shield before you can kill the boss. appears to
   be a cartoonish devil or something? ( it's absurdity )

**** what each character needs to learn
 - *zeno*: ghoka has been "touched", and is seeking a lost weapon of great power
 - *ureos*: someone from zeno's past is coming to town
 - *fox*: a larger regiment of the Royal Sable Army from the Hegemony is going to
   arrive in Ararholm soon
 - *belel*: captain ibakha togh is technically next in line to become ruler of the
   Voz Dynasty, so long as she can prove she's worthy
 - *klep*: pamki's heritage is important

from where they are, bring each character into the same data space

start with belel, she sees [[id:2844a0da-8f10-464f-ae63-0e42952affc2][first version]].

have her go through the clippy thing to get her into the same
place as all the other characters, and then have clippy glitch again and ask if
she wants to join her friends. if she says yes, she's put in the same data space
as fox. (room 1, red S). she appears in front of fox suddenly:

#+BEGIN_NOTE
Standing before you is an avatar of someone that looks kind of like Fox;

But it seems to be a caricature of them with long spindly limbs and oversized
hands and feet. Their expression seems to be stuck on a smug grin, and their
goggles are down over my eyes. They move fluidly and with maybe a bit more grace
than you're used to from Fox.
#+END_NOTE

switch to ureos, who also hasn't entered the datasphere proper. make sure nathan
doesn't say anything about what ureos's avatar looks like until they meet up
with the others. sees [[id:ef3753e0-26a4-4abc-bb8c-a929b64e1038][first version]], and on the ground next to them is an icon,
and when they get a message that is mostly garbled, but they can pick out two
words: "The Merchant", and "Shaper of Form".

switch back to belel and fox.

***** fox
his reality shifts and sees the [[id:ba1b365d-961f-42e8-8047-c59794f13e6d][second version]]. standing in front of him is a
man:

#+BEGIN_NOTE
Before you stands a man dressed in gleaming white clothes. You can't quite tell
how tall he his. Every time your eyes shift he seems to change height. Look at
him, he's 5 feet tall -- look away and back and he's 4'3". Or 6'5". 

His mannerisms are reserved yet considerate. There also seems to be an aura of
apathy to him, like nothing has ever gone right so why should now be any different?
#+END_NOTE

****** info
room 1: car on right has an info brochure for "Exploring The Amazing Jade
Forest of the Sable Hegemony!", car on the left has a lighter

room 7: a bunch of dead Royal Sable Army soldiers.

room 6: an army memo, mostly unreadable except for "...ending a full
regiment..."

room 8: another army memo, all that is readable is: "...le the situation in
Sudboia is stable, we need to ensure that Maka Tho is..."

room 12: an army report, mostly burned, but the last few pages are still
readable. the document seems to be plans for how the Sable Hegemony could secure
Maka Tho to ensure they are in control of it. the most important piece of
information is this paragraph on the last page:

"So therefore it is the recommendation of the 42nd Royal Battalion that should
the Sable Hegemony be in danger of losing control of the Grey Sea due to
incursions from antagonistic powers within Maka Tho that all steps be taken to
make the Grey Sea impassible. The 104th Armoured Battalion has an excellent
record of such area denial operations. The Hermanos Magma Mortar would be
particularly effective in collapsing the mountains, providing the Engineer
Corps. the time required to build fortifications to allow us to hold the other
end of the Grey Sea, potentially indefinitely."

***** klep
waiting for them in room 3.

when they meet up, their views shift:
  - klep sees [[id:3aeeda3d-c01f-4cdd-a409-017bb5130d16][second version]]
  - belel sees [[id:4f552248-b705-421f-a7cf-6fcd2657dbb9][second version]]
  - fox sees [[id:c870cb58-6d3b-458b-a48c-90db7e7c2042][third version]]

****** info
tidbits -- the following rooms have an "info plaque", a spot that if klep
interacts with it will give him a snippet of a story; The Lost Daughter.
...
Upon exiting the maze, he should be in the palace of the Sudkhan. This is also
when it'll switch to Wolfinstein 3D. Here he'll eventually find a picture that
looks like a younger version of Pamki, but different somehow. 

It should take him a little while to realize where he is. Whether he figures out
the painting is up to him.

The enemies should be caricatures of Sudboians.

At the end, he has a conversation with Absurdity, who should reveal he's not
really sure what the point of him is any more.

***** zeno
waiting for them in room 5

is a big mech.

views upgrade:
 - klep sees [[id:26628d29-4749-4e46-a357-15fb98831256][third version]]
 - belel sees [[id:9c8a873b-5e1f-4320-86fa-a271a04855f0][third version]]
   
zeno's view glitches and switches to [[id:cc70376c-7d4e-4a0f-8da3-e8df8392636e][this]],
****** info
 - in room 9, a garbled transmission -- from ghoka, dated recently
 - room 14 - 
...
***** ureos
:PROPERTIES:
:ID:       d3fb9084-1f10-4e9f-8cf2-1e523ac74151
:END:
waiting for them in room 7

his view switches to [[id:08bac3b0-d809-4e6d-ad99-a59bf7911b87][second version]]

switch again to [[id:6491f9af-60cc-4190-b2ed-7a0ae3cf2a10][third version]] when they get into room 15.
