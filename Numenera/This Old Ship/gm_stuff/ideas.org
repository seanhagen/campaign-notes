...
#+BEGIN_QUOTE
suddenly, a loud "bong" sounds from all around you, and the static is replaced by darkness. then, you see some glowing white text in the top-left of the face of the cube directly in front of the chair. it seems to be writing itself. it's in a language you don't understand, but it seems to be very succinct language, the sentences are very short. when the text eventually reaches the bottom, it begins to scroll up. What do you do?
#+END_QUOTE

whatever they do, eventually this happens:

#+BEGIN_QUOTE
after a few more moments, the face of the cube in front of you turns a bright blue, before dimming enough that you can make out some kind of display. there appears to be some kind of input required. what do you do?
#+END_QUOTE

***** if they inspect the chair
#+BEGIN_QUOTE
you notice that the armrests of the chair seem to have a set of keys built in. there are 15 keys on each armrest. they're not small enough that you can hit all the keys without having to move your hands. you also have to either lean forward or not sit with your back against the chair. whoever built this chair was larger than you.
...
#+BEGIN_QUOTE
the input fields flash red, and then clear. it seems you didn't type in the right thing. what do you do?
#+END_QUOTE

do that a few more times, depending on how often the person is responding

#+BEGIN_QUOTE
the input fields flash red one last time, then they go grey. a strange being pops into existence to the right of the input field. its body is like a spiral that has been stretched tall, with two great bugged out eyes stuck on random parts of the spiral and eyebrows hovering strangely above them. part of the spiral moves, and a low droning voice speaks in a language you don't understand.
...
******* if they haven't
#+BEGIN_QUOTE
The creature speaks, responding in Truth ( although from the accent you suspect they learned Truth from someone from the Steadfast ).

"Oh, i know this one! I'm sure glad we got that sorted out! I can't help you get this problem sorted out if we can't understand each other, now, can we?"

"My name is Clippy, and it seems like you're having problems logging in. Is there something i can help you with?"
#+END_QUOTE
