...
**** BACKLOG fill out scenario outline with descriptions
**** BACKLOG build the part of the ship that contains the broken equipment
need:
...
**** BACKLOG create map of ruin that they're sheltering in
...
do so
*** BACKLOG put clues in each ruin about "big bad" or overarching mystery [0/5]
**** BACKLOG scenario 2
**** BACKLOG scenario 3
**** BACKLOG scenario 5
**** BACKLOG scenario 6
**** BACKLOG scenario 7
** BACKLOG Finish populating town with major NPCs [7/19]
...
*** BACKLOG Dibbler [0%]
**** BACKLOG personality, basic details
- wants to be a rumor monger, but is really not very good at it
**** BACKLOG other details
-
** BACKLOG Create some goons & flesh out Ghoka's gang [%]
*** BACKLOG more on ghoka
**** BACKLOG stat him up
**** BACKLOG a little bit of history
**** BACKLOG what are his plans, really
*** BACKLOG his second-in-command
**** BACKLOG stats
**** BACKLOG little bio
*** BACKLOG the "voice of reason" gang member
**** BACKLOG stats
**** BACKLOG little bio
*** BACKLOG an insane/not-all-there "shaman"
**** BACKLOG stats
**** BACKLOG little bio** BACKLOG Sable Hegemony [0/5]
*** BACKLOG the empress/queen
** BACKLOG Voz Dynasty [0/6]
*** BACKLOG the khan
*** BACKLOG his daughter ( ager's wife )
** BACKLOG Maka-Tho [0/6]
*** BACKLOG make map of hills region for exploration by players
*** BACKLOG figure out where on region map the giant hand & screaming tower are
*** BACKLOG decide on scale
region needs to be at least as big as bc, alberta, and saskatchewan combined
*** BACKLOG figure out basic ecology of the hills region
  - what are some of the animals most likely to be seen?
  - what are the plants like?
*** BACKLOG decide if it's only the hills region plagued by the lightning storms
** BACKLOG Ararholm [40%]
*** BACKLOG write up articles for things already revealed on map [2/3]
**** DONE the pit
CLOSED: [2021-10-14 Thu 16:51]
**** DONE the city of the dead
CLOSED: [2021-10-14 Thu 16:51]
**** BACKLOG some of the 'tombs' & ruins nearby
*** BACKLOG maybe a map of the immediate area, but in a much more sketchy style
...
*** BACKLOG how exploring unknown hexes will work
*** BACKLOG travel distances & times & other considerations [2/2]
...
*** BACKLOG how big is a hex, for each "zoom level"
- in town:
- hills region:
- maka-tho:
- continent:
** physical prep [5/5]
*** CANCELLED create maps for me on hex paper                   :CANCELLED:
CLOSED: [2022-02-07 Mon 22:57]
:LOGBOOK:
- State "CANCELLED"  from "STARTED"    [2022-02-07 Mon 22:57]
:END:
*** CANCELLED on hex side of big battle mat, create map of all maka-tho :CANCELLED:
CLOSED: [2021-10-18 Mon 14:29]
:LOGBOOK:
- State "CANCELLED"  from "BACKLOG"       [2021-10-18 Mon 14:29] \\
...
:LOGBOOK:
- State "CANCELLED"  from "BACKLOG"       [2021-10-18 Mon 14:30] \\
  same as above
:END:
...
*** DONE determine what i want in front of me when running a game
CLOSED: [2022-02-07 Mon 22:57]
pretty much cards & laptop
...
CLOSED: [2021-10-11 Mon 15:44]
 - stuff like "it is unknown what Ager was up to during this X
    <year/month> period"
*** BACKLOG finish entries in timeline
...
*** BACKLOG figure out his personality a bit more
...
- [ ] others?
*** BACKLOG history of the war
** the ship [0/6]
*** BACKLOG more on the AI
...
*** BACKLOG some more info on the ship
  - is it even a ship?
...
** maka-tho [0/4]
*** BACKLOG is the device that created the mist destroyed, turned off, or being
  prevented from functioning ( in stasis, broken, etc )
*** BACKLOG was the mist to keep people out, keep something in, or... something else?
  - is that something else "knowable", or a mystery
*** BACKLOG what groups or civilizations survived under the mists?
  - cherry tree area
...
*** BACKLOG was the mist created before or after the beginning of the ninth world?
...
** BACKLOG figure out what the big problem is
...
** BACKLOG fill out the tavern with stuff
- crib from here: https://thealexandrian.net/wordpress/37558/roleplaying-games/numenera-tavern
* Next Session
** Figure Out
 - item level vs creature, who wins on ties ( creature or item )
 - how close other parties are to town ( sable army, merchant, others )
 - what is ghoka up to
 - what stuff in & around town needs to be handled sooner rather than later?
   - water?
   - demon t-rex thing?
   - families needing help?
   - ruins that need searching?
 - stuff in the ejected command arena they can salvage:
   - 2 Data Orbs
   - 100 units of synthsteel
   - 100 units of pliable metal
   - 50 units of responsive synth
   - 20 units of io
   - 2 units of philosophine
   - 3 cyphers

*** stuff they need to learn
 - many of the ruins used to be parts of the ship, it broke up as it crashed
 - one of the crystals they need to unlock the airship force field is here
 - one of the people traveling with the Royal Sable Army that's approaching is
   one of the Nightmares
 - one of the people traveling with the Merchant is a Nightmare
* Big Old To-Do List [0/6]
 - [-] clue tables! [3/5]
   - [X] list of artifacts they can find
   - [X] list of numenera plans
   - [X] nightmare clues
   - [ ] locations!
   - [ ] shuffle the tables into multiple variants
 - [ ] map of area at close scale
 - [ ] map of area at further scale
 - [ ] make nice print-out of community actions
 - [ ] make nice print-out of long-term actions
 - [ ] determine what the regiment is okay doing, how they're willing to help out
