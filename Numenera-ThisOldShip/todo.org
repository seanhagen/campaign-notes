...
** STARTED Need several potential scenarios & encounters [25/37]
sheriff:
 - scenario 1
 - scenario 5
...
*** STARTED scenario 1: in town (ghoka)
...
** TODO Finish populating town with major NPCs [4/19]
*** TODO the "seamstress" madam [33%]
**** DONE name
...
* Can wait until after first session [30%]
:PROPERTIES:
:COOKIE_DATA: todo recursive
:END:
** Ager [10/12]
