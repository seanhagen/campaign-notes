...
** TODO stat up the equipment mex is building [0/5]
DEADLINE: <2021-12-05 Sun>
- how long it'll take
...
*Cost:* 10 shins
*Parts:* 5 iotum
*Output*: Buckler shield, eases Speed defense one level

klep needs his stuff first

*** TODO bracer/shield for Belel
*Time*: 8 days (artifact) 
*Cost:* paid
*Parts:*
*Output*: 
...
*Cost:* paid
*Parts:*
*Output*: pair of bracers ease disarming by one step

- maybe should have a bonus for disarming opponents
** MONSTERS
players have chosen that they're gonna be fighting [[file:scenarios/scenario-5.org::*an alchemical circle, broken in half][these]]
*** deceit
*** doubt
*** hate
*** vanity
